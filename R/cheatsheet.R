...
cheatsheet_css <- function() {
  paste(
    ...
    "  .page-title { font-size: 18pt; margin-bottom: 0.15rem; }",
    "  .page-subtitle { font-size: 9pt; }",
    ...
    "  }",
    "  .page-toc h2 { margin-bottom: 0.4rem; font-size: 12pt; }",
    "  .page-toc ul { columns: 2; column-gap: 1.2rem; }",
    "  .page-content { min-width: 0; }",
    "  .intro-block { margin-bottom: 0.8rem; }",
    "  .intro-note { padding: 0.6rem 0.8rem; margin-top: 0.6rem; }",
    "  .page-content > .cheatsheet-section {",
    "    break-before: page;",
    "    page-break-before: always;",
    "    margin-bottom: 0;",
    "  }",
    "  .page-content > .cheatsheet-section:first-of-type {",
    "    break-before: auto;",
    "    page-break-before: auto;",
    "  }",
    "  .cheatsheet-section h1 { font-size: 15pt; margin-bottom: 0.3rem; }",
    "  .cheatsheet-section h2 { font-size: 11pt; margin-top: 0.8rem; margin-bottom: 0.25rem; }",
    "  .cheatsheet-section p, .cheatsheet-section li, .page-toc li { font-size: 8.6pt; }",
    "  .cheatsheet-table {",
    ...
    "  }",
    "  .cheatsheet-figure, figure, blockquote {",
    "    break-inside: avoid-page;",
    "    page-break-inside: avoid;",
    "  }",
    "  .cheatsheet-figure { margin: 0.45rem 0 0.8rem 0; }",
    "  .cheatsheet-figure img { max-height: 150mm; object-fit: contain; }",
    "  .gt_table, .gt_table * { font-size: 7.8pt !important; }",
    "  .gt_table { width: 100% !important; }",
    "  .gt_table td, .gt_table th { padding-top: 2px !important; padding-bottom: 2px !important; }",
    "  .gt_footnotes { font-size: 7pt !important; }",
    "}",
    sep = "\n"
  )
}
