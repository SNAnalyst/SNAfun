...
This chapter gathers the functions for *components* (structural cohesion:
counting and extracting components, cut vertices, and bridges) and
*communities* (subgroup detection and everything you do with the result).
The comparison table below lists them next to their `igraph`/`network`
equivalents.

```{r table_components_communities, echo = FALSE, eval = TRUE}
