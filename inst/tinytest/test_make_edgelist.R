...
# igraph
expect_identical(make_edgelist(g_i, sort = "to"), igraph::as_data_frame(g_i))
expect_identical(make_edgelist(g1_i, sort = "to"), igraph::as_data_frame(g1_i))
expect_identical(make_edgelist(g2_i, sort = "weight"), igraph::as_data_frame(g2_i))
expect_identical(colnames(make_edgelist(g3_i)), c("from", "to", "weight", "color"))
